...
w1, w2 = make_separate(top10_words)
c1, c2 = make_separate(top10_letters)
e1, e2 = make_separate(top10_emojies)
minChar = str(min_char(count_df))
maxChar = str(max_char(count_df))
avgChar = str(avg(count_df))
mostTexted = str(common_txt())
